...
<section class="package" id="math-base-tools-unreleased">
...
<section class="package" id="math-base-tools-evalpoly-unreleased">
...
<section class="package" id="math-base-tools-evalpoly-compile-unreleased">
...
<section class="package" id="math-base-tools-evalpoly-compile-c-unreleased">
...
<section class="package" id="math-base-tools-evalpolyf-unreleased">
...
<section class="package" id="math-base-tools-evalrational-unreleased">
...
<section class="package" id="math-base-tools-evalrational-compile-unreleased">
...
<section class="package" id="math-base-tools-evalrational-compile-c-unreleased">
...
<section class="package" id="math-base-tools-evalrationalf-unreleased">
...
<section class="package" id="math-base-tools-fibpoly-unreleased">
...
<section class="package" id="math-base-tools-hermitepoly-unreleased">
...
<section class="package" id="math-base-tools-lucaspoly-unreleased">
...
<section class="package" id="math-base-tools-normhermitepoly-unreleased">
...
<section class="package" id="math-base-tools-normhermitepolyf-unreleased">
...
-   [`113b4fe`](https://github.com/stdlib-js/stdlib/commit/113b4feb3902f939de8986e7983e35414242d6e4) - **docs:** update namespace table of contents [(#2034)](https://github.com/stdlib-js/stdlib/pull/2034) _(by stdlib-bot, Athan Reines)_
-   [`6affd28`](https://github.com/stdlib-js/stdlib/commit/6affd2816c0458b63cd17f496f823850db9235e5) - **feat:** update namespace TypeScript declarations [(#2032)](https://github.com/stdlib-js/stdlib/pull/2032) _(by stdlib-bot, Athan Reines)_
...
-   [`5564766`](https://github.com/stdlib-js/stdlib/commit/55647661f551a753ba247511606eba2ee4766db8) - **feat:** add `evalrationalf` to namespace _(by Athan Reines)_
...
-   [`6a9ffa5`](https://github.com/stdlib-js/stdlib/commit/6a9ffa5da5c93317ee63b490231d9dd4b8d249da) - **test:** use strictEqual assertion _(by Athan Reines)_
-   [`b923036`](https://github.com/stdlib-js/stdlib/commit/b923036aa54a63f4ecd846fce9427979c8637707) - **refactor:** rename type and rearrange tests _(by Athan Reines)_
-   [`d528fff`](https://github.com/stdlib-js/stdlib/commit/d528fff488e958ec970ebceb01bed1eb238f136a) - **docs:** update examples _(by Athan Reines)_
-   [`42581f1`](https://github.com/stdlib-js/stdlib/commit/42581f19a031ee7f604b55a94b914831f38117f4) - **docs:** update descriptions _(by Athan Reines)_
-   [`ad7a467`](https://github.com/stdlib-js/stdlib/commit/ad7a467902986bed791b64861b6a7e1071c26f9a) - **bench:** refactor value generation _(by Athan Reines)_
-   [`aa5d241`](https://github.com/stdlib-js/stdlib/commit/aa5d241579301751fbec3ba654832a07157d12bb) - **test:** update test messages _(by Athan Reines)_
-   [`bea580c`](https://github.com/stdlib-js/stdlib/commit/bea580c60303930521a921a39ccb35cd08a31f71) - **feat:** add `evalpolyf` to namespace _(by Athan Reines)_
...
-   [`deff338`](https://github.com/stdlib-js/stdlib/commit/deff338403ef0bdc936e5f367bfbefbab76f2a05) - **fix:** allow array-like objects _(by Athan Reines)_
...
<section class="package" id="math-base-tools-evalrational-compile-v0.2.1">
...
<section class="package" id="math-base-tools-v0.2.0">
...
<section class="package" id="math-base-tools-continued-fraction-v0.2.0">
...
<section class="package" id="math-base-tools-evalpoly-compile-v0.2.0">
...
<section class="package" id="math-base-tools-evalrational-compile-v0.2.0">
...
<section class="package" id="math-base-tools-evalrational-compile-c-v0.2.0">
...
<section class="package" id="math-base-tools-fibpoly-v0.2.0">
...
<section class="package" id="math-base-tools-sum-series-v0.2.0">
