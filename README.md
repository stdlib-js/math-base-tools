...
```javascript
import { chebyshevSeries, chebyshevSeriesf, continuedFraction, evalpoly, evalpolyf, evalrational, evalrationalf, fibpoly, hermitepoly, lucaspoly, normhermitepoly, normhermitepolyf, sumSeries } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-tools@esm/index.mjs';
```
...
[@stdlib/math/base/tools/chebyshev-series]: https://github.com/stdlib-js/math-base-tools-chebyshev-series/tree/esm

[@stdlib/math/base/tools/chebyshev-seriesf]: https://github.com/stdlib-js/math-base-tools-chebyshev-seriesf/tree/esm
