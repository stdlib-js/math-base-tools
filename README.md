...
```javascript
import { chebyshevSeries, continuedFraction, evalpoly, evalpolyf, evalrational, evalrationalf, fibpoly, hermitepoly, lucaspoly, normhermitepoly, normhermitepolyf, sumSeries } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-tools@deno/mod.js';
```
