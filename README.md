...
```javascript
import { continuedFraction, evalpoly, evalpolyf, evalrational, fibpoly, hermitepoly, lucaspoly, normhermitepoly, sumSeries } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-tools@deno/mod.js';
```
