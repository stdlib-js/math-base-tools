...
```javascript
import { continuedFraction, evalpoly, evalpolyf, evalrational, evalrationalf, fibpoly, hermitepoly, lucaspoly, normhermitepoly, sumSeries } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-tools@esm/index.mjs';
```
